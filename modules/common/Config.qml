    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string taskManager: "/usr/local/bin/missioncenter"
                ...
                property string update: "kitty -e sudo xbps-install -Syu" // Command to run system updates
            }
