            ...
            RowLayout {
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        Config.setNestedValue("apps.update", "foot -e sudo xbps-install -Syu")
                    }
                }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        Config.setNestedValue("apps.update", "kitty -e sudo xbps-install -Syu")
                    }
                }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        Config.setNestedValue("apps.update", "ghostty -e sudo xbps-install -Syu")
                    }
                }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        Config.setNestedValue("apps.update", "alacritty -e sudo xbps-install -Syu")
                    }
                }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        Config.setNestedValue("apps.update", "wezterm -e sudo xbps-install -Syu")
                    }
                }
                ...
                RippleButton {
                    ...
                    onClicked: {
                        ...
                        Config.setNestedValue("apps.update", "konsole -e sudo xbps-install -Syu")
                    }
                }
            }
