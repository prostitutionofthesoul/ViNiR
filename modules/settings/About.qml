...
ContentPage {
    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            RowLayout {
                ...
                Rectangle {
                    ...
                    Image {
                        ...
                        source: Quickshell.shellPath("assets/icons/vinir.png") // Убедись, что иконка есть по этому пути
                        fillMode: Image.PreserveAspectFit
                    ...
                    MaterialSymbol {
                        anchors.centerIn: parent
                        visible: vinirIcon.status !== Image.Ready
                        text: "bolt"
                        iconSize: 48
                        color: Appearance.m3colors.m3primary
                    }
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        text: "[github.com/prostitutionofthesoul/ViNiR](https://github.com/prostitutionofthesoul/ViNiR)"
                        font.pixelSize: Appearance.font.pixelSize.small
                        color: Appearance.m3colors.m3primary
                        textFormat: Text.MarkdownText
                        onLinkActivated: link => Qt.openUrlExternally(link)
            ...
            StyledText {
                Layout.fillWidth: true
                text: "ViNiR is a specialized fork of the iNiR project for Void Linux."
            ...
            Flow {
                ...
                RippleButtonWithIcon {
                    ...
                    onClicked: Qt.openUrlExternally("https://github.com/prostitutionofthesoul/ViNiR")
                }
                RippleButtonWithIcon {
                    materialIcon: "history"
                    mainText: "Changelog"
                    onClicked: Qt.openUrlExternally("https://github.com/prostitutionofthesoul/ViNiR/commits/main")
                }
            }
        }
    }
