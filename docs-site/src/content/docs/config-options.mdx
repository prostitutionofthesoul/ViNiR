...
The launcher supports multiple **prefixes** to switch between different modes (apps, actions, calculator, web search, etc.).
You can customize them under `search.prefix`.
...
```json
{
  ...
  "dock": {
    "position": "bottom",
    "height": 60,
    "pinnedApps": ["firefox", "kitty", "nautilus"]
  },
  "background": {
    "wallpaperPath": "/home/user/Pictures/wallpaper.jpg"
  },
